    ...
    <section class="mt-8 mx-16">
        ...
        <form class="mb-4" action="{{ route('posts.comments.store', ['post' => $post->id]) }}" method="post">
            ...
            <div class="flex items-center py-2 px-3 bg-gray-200 rounded-lg dark:bg-gray-700">
                ...
                <textarea name="message" id="chat" rows="1" class="@error('message') is-invalid @enderror block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
